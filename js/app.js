...
//Question Data
	var Question1={type:"Question 1",questionNumber: 1,correctAnswer:0,
	...
	chocieListData:['<li><h3><input type="radio" name="radio" id="radiocheckbox" value="0">A</h3></li>','<li><h3><input type="radio" name="radio" id="radiocheckbox" value="1">B</h3></li>','<li><h3><input type="radio" name="radio" id="radiocheckbox" value="2">C</h3></li>','<li><h3><input type="radio" name="radio" id="radiocheckbox" value="3">D</h3></li>'],
	questionData: "Computer Hardware Question: Which one of the following pictures is Random Access Memory(RAM)?"
	};
	var Question2={type:"Question 2",questionNumber: 2,correctAnswer:2,
	...
	var Question3={type:"Question 3",questionNumber: 3,correctAnswer:3,
	...
	var Question4={type:"Question 4",questionNumber: 4,correctAnswer:1,
	...
	var Question5={type:"Question 5",questionNumber: 5,correctAnswer:3,
...
//EndQuestionDATA
//StatCollectionData
	var Stats={type:"Stats",correctAmount:0,questionCount:0,percentCorrect:0,percentIncorrect:0,startTime:null,endTime:null };
//Variables
	var answer;
	var correctAnswer;
	var questionCounter;
	...
	$(".bannerbuttons").on("click",".helpbutton",function(){
		window.open('https://www.google.com')
		alert("The game is pretty much self explanatory, google may be able to help you find answers though!");
	});
//Functions
	function newGame(){
